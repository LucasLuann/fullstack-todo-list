...
const TodoList = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const url = editingId
      ? `http://localhost:8080/api/todos/${editingId}`
  ...
  const handleDeleteAll = async () => {
    try {
      ...
      alert("Erro ao resetar as tarefas: " + err.message);
    }
  };
  ...
  const confirmDelete = async () => {
    ...
    try {
      const res = await fetch(
        `http://localhost:8080/api/todos/${todoToDelete.id}`,
        {
          method: "DELETE",
        }
      );
  ...
  return (
    <div className="min-h-screen h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-4">
        ...
        <div className="mb-6 flex items-center justify-between">
          <h2 className="text-2xl font-bold text-slate-800 flex items-center gap-2">
            ...
            {totalCount > 0 && (
              <Badge
                variant="secondary"
                className="bg-slate-100 text-slate-700 ml-2"
              >
                ...
                {deleteMode ? (
                  ...
                  <>
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        Tem certeza que deseja excluir esta tarefa? Esta ação
                    ...
                    <div className="py-4">
                      <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                        ...
                        <p className="text-sm text-red-600 mt-1">
                          Status:{" "}
                          {todoToDelete?.isComplete ? "Concluída" : "Pendente"}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="grid gap-4 py-4">
                      <div className="grid gap-3">
                        ...
                        <Input
                          ...
                          placeholder="Ex: Maratonar Breaking Bad"
                          required
